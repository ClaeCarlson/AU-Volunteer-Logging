...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { hoursId: @hour.hoursId, hoursWorked: @hour.hoursWorked, volunteerId: @hour.volunteerId, weekWorked: @hour.weekWorked } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { hoursId: @hour.hoursId, hoursWorked: @hour.hoursWorked, volunteerId: @hour.volunteerId, weekWorked: @hour.weekWorked } }
